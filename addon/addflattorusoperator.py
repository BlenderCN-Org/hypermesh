...
class AddFlatTorusOperator(bpy.types.Operator):
    ...
    radius1 = bpy.props.FloatProperty(name="Radius 1", default=1.0, subtype='DISTANCE',
        description="Radius for the circle in the first plane of the decomposition")
    radius2 = bpy.props.FloatProperty(name="Radius 2", default=1.0, subtype='DISTANCE',
        description="Radius for the circle in the second plane of the decomposition")
    segmentcount1 = bpy.props.IntProperty(name="Vertices 1", default=32, min=3,
        description="Number of vertices along circle in first plane")
    segmentcount2 = bpy.props.IntProperty(name="Vertices 2", default=32, min=3,
